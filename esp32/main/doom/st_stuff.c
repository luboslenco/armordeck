...
#else
#define ST_FACESX     128 / 2
#define ST_FACESY     200 / 2
#endif
...
#define ST_AMMOX			135
// #define ST_AMMOY     171
#define ST_AMMOY			171/1.6

// HEALTH number pos.
#define ST_HEALTHWIDTH		3
// #define ST_HEALTHX     90
#define ST_HEALTHX			55
// #define ST_HEALTHY     171
#define ST_HEALTHY			171/1.6
...
// byte 										st_backing_screen[ST_WIDTH * ST_HEIGHT];
...
#ifdef DOOM_TINY
cheatseq_t cheat_mus = CHEAT("i", 2);
cheatseq_t cheat_god = CHEAT("i", 0);
cheatseq_t cheat_ammo = CHEAT("i", 0);
cheatseq_t cheat_ammonokey = CHEAT("i", 0);
cheatseq_t cheat_noclip = CHEAT("i", 0);
cheatseq_t cheat_commercial_noclip = CHEAT("i", 0);
#else
...
#ifdef DOOM_TINY
cheatseq_t cheat_choppers = CHEAT("i", 0);
cheatseq_t cheat_clev = CHEAT("i", 2);
cheatseq_t cheat_mypos = CHEAT("i", 0);
#else
...
void ST_Init (void)
{
    ...
    st_backing_screen = (byte *)I_VideoBuffer + SCREENWIDTH * ST_Y;
}
