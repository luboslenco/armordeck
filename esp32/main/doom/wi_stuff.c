...
const static point_t lnodes[NUMEPISODES][NUMMAPS] =
{
    // Episode 0 World Map
    {
...
const static anim_t epsd1animinfo[] =
{
...
const static anim_t epsd2animinfo[] =
{
...
const static int NUMANIMS[NUMEPISODES] =
{
