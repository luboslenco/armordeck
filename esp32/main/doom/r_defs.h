...
typedef struct PACKEDATTR
{
    ...
    short	textureoffset_short;

    // add this to the calculated texture top
    // fixed_t  rowoffset;
    short	rowoffset_short;
...
typedef struct PACKEDATTR line_s
{
    maplinedef_t* mld;
...
//
typedef struct PACKEDATTR subsector_s
{
    sector_t*	sector;
    short	numlines;
    short	firstline;
...
// ?
//
typedef struct PACKEDATTR drawseg_s
{
    seg_t*		curline;
    // int          x1;
    short			x1;
...
typedef struct PACKEDATTR vissprite_s
{
    // Doubly linked list.
