...
// const boolean         precache = true;        // if true, load all graphics at start
...
static const short *weapon_keys[] = {
    &key_weapon1,
    &key_weapon2,
    &key_weapon3,
    &key_weapon4,
...
#else
#define MAX_JOY_BUTTONS 1
#endif

// static boolean  gamekeydown[NUMKEYS];
static uint32_t gamekeydown_bitmap[8];
