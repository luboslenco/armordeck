  ...
  int			x2 )
{
    ...
    //// !!!!
    /*else if (vis->mobjflags & MF_TRANSLATION) // vis->thing->flags
    {
	colfunc = transcolfunc;
	dc_translation = translationtables - 256 +
	    ( (vis->mobjflags & MF_TRANSLATION) >> (MF_TRANSSHIFT-8) ); // vis->thing->flags
    }*/
...
void R_ProjectSprite (mobj_t* thing)
{
    ...
    else
    {
    	// diminished light
        // #ifdef DOOM_HALFRES
        // index = (xscale>>(LIGHTSCALESHIFT-detailshift)) << 1;
        // #else
